...
public class Cheatsheet : Gtk.Dialog {
    ...
    public Cheatsheet () {
        ...
        labels += generate_label (_("Add a new name"));
        shortcuts += generate_entry ("ctrl + a");

        labels += generate_label (_("Randomly choose a winner"));
        shortcuts += generate_entry ("ctrl + w");
        ...
        labels += generate_label (_("Import names from CSV"));
